...
3:                                                ; preds = %1
  %4 = tail call i8* @__cxa_allocate_exception(i64 16) #10
...
6:                                                ; preds = %3
  tail call void @__cxa_throw(i8* %4, i8* bitcast (i8** @_ZTISt16invalid_argument to i8*), i8* bitcast (void (%"class.std::invalid_argument"*)* @_ZNSt16invalid_argumentD1Ev to i8*)) #11
  unreachable

7:                                                ; preds = %3
  %8 = landingpad { i8*, i32 }
          cleanup
  tail call void @__cxa_free_exception(i8* %4) #10
  resume { i8*, i32 } %8
...
define dso_local noundef i32 @main() local_unnamed_addr #6 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %12 = tail call i8* @__cxa_allocate_exception(i64 16) #10
...
16:                                               ; preds = %0
  ...
  tail call void @__cxa_free_exception(i8* %12) #10
  br label %20
...
20:                                               ; preds = %16, %18
  ...
  %23 = tail call i32 @llvm.eh.typeid.for(i8* bitcast (i8** @_ZTISt16invalid_argument to i8*)) #10
  %24 = icmp eq i32 %22, %23
  br i1 %24, label %25, label %40

25:                                               ; preds = %20
  %26 = extractvalue { i8*, i32 } %21, 0
  %27 = tail call i8* @__cxa_begin_catch(i8* %26) #10
  ...
  %33 = tail call noundef i8* %32(%"class.std::logic_error"* noundef nonnull align 8 dereferenceable(16) %28) #10
